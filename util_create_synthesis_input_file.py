...
if(len(sys.argv) < 3):
    print("Error: Requires two positional arguments: input csv filename, and output csv filename")
    exit(2)
...
print(f"Wrote {len(words_list)} lines to {output_file}")